...
function MoviesCardList(props) {
  ...
  const handleResize = () => {
    ...
    if (screenWidth >= SCREEN_RESOLUTION.WIDTH_1231) {
      setCardCount(PAGINATION.PAGE_ITEMS.SCREEN.WIDTH_1231.PAGE_ITEMS);
      setLoadCount(PAGINATION.PAGE_ITEMS.SCREEN.WIDTH_1231.LOAD_ITEMS);
    } else if (screenWidth >= SCREEN_RESOLUTION.WIDTH_921) {
      setCardCount(PAGINATION.PAGE_ITEMS.SCREEN.WIDTH_921.PAGE_ITEMS);
      setLoadCount(PAGINATION.PAGE_ITEMS.SCREEN.WIDTH_921.LOAD_ITEMS);
    } else if (screenWidth >= SCREEN_RESOLUTION.WIDTH_731) {
      setCardCount(PAGINATION.PAGE_ITEMS.SCREEN.WIDTH_731.PAGE_ITEMS);
      setLoadCount(PAGINATION.PAGE_ITEMS.SCREEN.WIDTH_731.LOAD_ITEMS);
